    ...
    public static class ItemFactory
    {
        ...
        static ItemFactory()
        {
            if (File.Exists(GAME_DATA_FILENAME))
            {
                ...
                LoadItemsFromNodes(data.SelectNodes("/GameItems/Weapons/Weapon"), false);
                LoadItemsFromNodes(data.SelectNodes("/GameItems/HealingItems/HealingItem"), false);
                LoadItemsFromNodes(data.SelectNodes("/GameItems/MiscellaneousItems/MiscellaneousItem"), false);
            }
            else
            {
        ...
        private static void LoadItemsFromNodes(XmlNodeList nodes, bool v)
        {
            if (nodes == null)
            {
                return;
